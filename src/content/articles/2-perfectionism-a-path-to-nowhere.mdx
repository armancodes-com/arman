...
image: "/articles/2-perfectionism-a-path-to-nowhere/perfectionism-a-path-to-nowhere.jpg"
hasSeries: false
blogSeriesLinks:
  [
    {
    ...
    { title: "Perfectionism: A Path to Nowhere", isCurrent: true, episode: 2 },
  ]
currentArticleSeriesEpisode: 2
---
